...
export default defineConfig({
  shortcuts: {
    ...
    'text-base': 'text-[#20202a] dark:text-[#f0f0f0] transition duration-100',
    ...
    'text-subtitle': 'text-base text-xl md:text-2xl font-bold text-start',
    'text-title': 'text-base text-3xl md:text-5xl font-bold text-start',
    'text-section-title': 'text-base text-xl md:text-2xl font-bold text-start relative before:content-empty before:absolute before:h-full before:w-1 before:bg-primary before:left-0 pl-3',
